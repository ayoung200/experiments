...
#include "./EnjaParticles/rtpslib/RTPS.h"
#include "./EnjaParticles/rtpslib/render/ParticleEffect.h"
#include "./EnjaParticles/rtpslib/render/SSEffect.h"
#include "./EnjaParticles/rtpslib/render/StreamlineEffect.h"
#include "./EnjaParticles/rtpslib/render/ShaderLibrary.h"
#include "./EnjaParticles/rtpslib/system/SPH.h"
...
#define CUSTOM_CL_INITIALIZATION
    ...
    settings->SetSetting("gas_constant",1.0);
    settings->SetSetting("viscosity",0.001);
    settings->SetSetting("velocity_limit",600.0);
    settings->SetSetting("xsph_factor",0.15);
    settings->SetSetting("friction_kinetic",0.2);
    settings->SetSetting("friction static",0.0);
    settings->SetSetting("boundary_stiffness",20000.0);
    ...
    rs.particleRadius = sph->getSpacing()*20.f;
    rs.windowWidth=m_glutScreenWidth;
    ...
    rs.blending=true;
    rs.particleRadius = sph->getSpacing()*.6f;
    ssRenderer=new rtps::SSEffect(rs, *lib);
    meshRenderer=new rtps::MeshEffect(rs, *lib);
